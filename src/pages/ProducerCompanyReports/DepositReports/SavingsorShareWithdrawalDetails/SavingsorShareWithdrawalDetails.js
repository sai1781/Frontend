...
const SavingsOrShareWithdrawalDetails = () => {
      ...
      <Space size={20} direction="vertical">
        <Space size={10} className="DReportscards">
          ...
          <Select defaultValue="Select" style={{ width: 120 }} onChange={value => setSelectedFromDate(value)}>
            ...
            <Select.Option value="All">Share capital Withdrawal</Select.Option>
            <Select.Option value="Deposit">Saving Account Withdrawal</Select.Option>
            {/* <Select.Option value="Withdrawal">SEP-2023</Select.Option> */}
          </Select>
...
export default SavingsOrShareWithdrawalDetails;
