...
const MemberDetailsReports = () => {
  ...
  <Space size={10}>
    ...
    <DatePicker onChange={date => setSelectedToDate(date)} style={{ width: '300px' }} />
    <Button
      type="primary"
    
      style={{ backgroundColor: bluecolor, height: "35px", width: "145px" }}
    >
      Apply
    </Button>
    <Button
      ...
      style={{ backgroundColor: orangeColor, height: "35px", width: "145px" }}
    >
      Print
    </Button>
  </Space>
...
export default MemberDetailsReports;
