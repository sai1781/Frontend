...
function MonthlyMaturityReports() {
  ...
  return (
    ...
    <DatePicker onChange={date => setSelectedFromDate(date)} style={{ width: '250px' }} />
    <Typography.Text>To Date:</Typography.Text>
    <DatePicker onChange={date => setSelectedToDate(date)} style={{ width: '250px' }} />
...
export default MonthlyMaturityReports;
