...
function AppReports() {
  ...
  return (
    <div className="reports-container">
      ...
      <Typography.Title level={4} id="text">Mobile App Collection Report</Typography.Title>

        <div id='Form' className="dropdown-container">
          <Space size={10} align="center">
            <Typography.Text className="left-text" id='details'>Collection Ex.Name :</Typography.Text>
            <Dropdown overlay={generateDropdownMenu(0, ["hellloo", "world"])}>
              <Button>
                {depositType || "Select"} <DownOutlined />
              </Button>
            ...
            <Typography.Text className="left-text" id='details'>Account Type :</Typography.Text>
            <Dropdown overlay={generateDropdownMenu(1, ["Select", "All", "Saving"])}>
              <Button className="dropdown-select">
                {accountNo || "Account Number"} <DownOutlined />
              </Button>
            </Dropdown>
            <Typography.Text id='details'>From Date:</Typography.Text>
            <DatePicker onChange={date => setSelectedFromDate(date)} />
            <Typography.Text id='details'>To Date:</Typography.Text>
            <DatePicker onChange={date => setSelectedToDate(date)} />
            <Button  onClick={handleApplyButtonClick} className="ak">
            Apply
          </Button>
          <Button  icon={<PrinterOutlined />} onClick={handlePrintButtonClick} className="ak1">
            Print
          </Button>
          </Space>
          
        </div>
        <Space  id='Form'size={10} direction="horizontal">
