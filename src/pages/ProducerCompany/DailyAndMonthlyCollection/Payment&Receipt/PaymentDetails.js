      ...
      <Space size={20} direction="vertical">
        <div className="dropdown-container">
          ...
          <Typography.Text>From Date:</Typography.Text>
            ...
            <Dropdown overlay={generateDropdownMenu(1, ["Select", "Receipts", "Payment","Bank"])}>
              <Button className="dropdown-select">
                { "Select Type"} <DownOutlined />
              </Button>
            </Dropdown>
            <Typography.Text className="left-text">Render Types:</Typography.Text>
            <Dropdown overlay={generateDropdownMenu(0, ["PDF", "Excel"])}>
              <Button>
