                  ...
                  <>
                    <div className="form-row row">
                      ...
                      <div className="form-group p-2 col-lg-4 col-md-6">
                        ...
                        >
                          <MenuItem value="option1">Select</MenuItem>
                          <MenuItem value="option2">Savings Account</MenuItem>
                          <MenuItem value="option3">Current Account</MenuItem>
                          <MenuItem value="option4">Daily Deposit</MenuItem>
                          <MenuItem value="option5">Thrift Savings Deposit</MenuItem>
                      ...
                      <div className="form-group p-2 col-lg-4 col-md-6">
                        ...
                        >
                          <MenuItem value="option1">Select</MenuItem>
                          <MenuItem value="option2">Single</MenuItem>
                          <MenuItem value="option3">Joint</MenuItem>
                          <MenuItem value="option4">Eitheror</MenuItem>
